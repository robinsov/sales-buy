...
const routes: Routes = [
  ...
  {path: 'anuncios/:source', component: AnunciosComponent},
  {path: 'anuncios/:source/:valor', component: AnunciosComponent},
  {path: 'login', component: LoginComponent},
  {path: 'register', component: RegisterComponent},
  {path: 'categorias', component: CategoriasComponent},
  {path: 'misAnuncios', component: MisAnunciosComponent},
  {path: 'perfil/:id', component: PerfilComponent},
  {path: 'detalles/:id', component: DetallesAnuncioComponent},
  
  {path: 'anuncio/:source', component: AnuncioFormComponent},
];
